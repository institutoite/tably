            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <Label htmlFor="resumida" className={`flex items-start space-x-3 p-4 rounded-lg border-2 cursor-pointer transition-all ${testMode === 'resumida' ? 'border-[rgb(38,186,165)] bg-[rgb(38,186,165)]/10' : 'border-slate-200 dark:border-slate-700 hover:border-[rgb(38,186,165)]/50'}`}>
                    <input type="radio" id="resumida" name="testMode" value="resumida" checked={testMode === 'resumida'} onChange={(e) => setTestMode(e.target.value)} className="mt-1"/>
                    <div>
                  ...
                  <Label htmlFor="completa" className={`flex items-start space-x-3 p-4 rounded-lg border-2 cursor-pointer transition-all ${testMode === 'completa' ? 'border-[rgb(38,186,165)] bg-[rgb(38,186,165)]/10' : 'border-slate-200 dark:border-slate-700 hover:border-[rgb(38,186,165)]/50'}`}>
                    <input type="radio" id="completa" name="testMode" value="completa" checked={testMode === 'completa'} onChange={(e) => setTestMode(e.target.value)} className="mt-1"/>
                    <div>
          ...
          <div>
            <Card className="sticky top-24">
              ...
              <CardContent className="space-y-4">
                ...
                <Button onClick={startTest} disabled={selectedTables.length === 0} className="w-full primary-gradient hover:opacity-90 transition-opacity"><Play className="w-4 h-4 mr-2" />Comenzar Test</Button>
              </CardContent>
            </Card>
          </div>
        </div>
